  ...
  return (
    <div>
      ...
      >
        ...
        <SectionCard
          title="Как применить на практике"
          icon="📖"
          content={
            <div style={{ padding: "0.5rem", ...commonTextStyle }}>
              Чтобы не слишком сильно вас утруждать бесконечными практиками и
              нудной теорией, мы подготовили для вас методичку, которая решит
